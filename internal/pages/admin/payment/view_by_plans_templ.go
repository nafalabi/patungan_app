...
func ViewByPlans(planDues []payment.PlanDuesGroup, currentUserID uint, currentUserType models.UserType, nextOffset int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(planDues) == 0 {
			...
			templ_7745c5c3_Err = PlanListItems(planDues, currentUserID, currentUserType).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
...
func PlanListItems(planDues []payment.PlanDuesGroup, currentUserID uint, currentUserType models.UserType) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		for _, pwd := range planDues {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/pages/admin/payment/view_by_plans.templ`, Line: 36, Col: 101}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/pages/admin/payment/view_by_plans.templ`, Line: 38, Col: 106}
			}
			...
			if len(pwd.Periods) > 0 {
				for _, pwd_period := range pwd.Periods {
					...
					if pwd_period.Period.ID != 0 {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/pages/admin/payment/view_by_plans.templ`, Line: 54, Col: 34}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/pages/admin/payment/view_by_plans.templ`, Line: 56, Col: 61}
						}
...
func LoadMorePlansButton(nextOffset int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if nextOffset > 0 {
			...
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("/admin/payment-dues?view=plans&offset=%d", nextOffset))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/pages/admin/payment/view_by_plans.templ`, Line: 82, Col: 80}
			}
