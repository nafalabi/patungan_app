...
func Header(breadcrumbs []types.Breadcrumb, userEmail string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for i, crumb := range breadcrumbs {
			...
			if crumb.URL != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/template/layouts/header.templ`, Line: 15, Col: 40}
				}
