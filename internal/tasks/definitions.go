...
func DefineTasks() {
	...
	RegisterHandler("log_info", func(ctx context.Context, db *gorm.DB, args map[string]interface{}) (map[string]interface{}, error) {
	...
	// Add more tasks here
	RegisterHandler("process_plan_schedule", func(ctx context.Context, db *gorm.DB, args map[string]interface{}) (map[string]interface{}, error) {
