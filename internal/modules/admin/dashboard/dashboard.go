...
import (
	...
	dashboard_pages "patungan_app_echo/internal/modules/admin/dashboard/pages"
...
func (h *DashboardHandler) Dashboard(c echo.Context) error {
	...
	props := dashboard_pages.DashboardProps{
		Title:            "Dashboard",
		ActiveNav:        "dashboard",
	...
	return dashboard_pages.Dashboard(props).Render(c.Request().Context(), c.Response())
}
