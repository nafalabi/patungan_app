...
import (
	...
	user_pages "patungan_app_echo/internal/modules/admin/user/pages"
	"strconv"
...
func (h *UserPreferenceHandler) GetUserPreference(c echo.Context) error {
	...
	return user_pages.UserPreferencePopup(user, pref).Render(c.Request().Context(), c.Response())
}
...
func (h *UserPreferenceHandler) UpdateUserPreference(c echo.Context) error {
	...
	return user_pages.UserPreferenceSuccess().Render(c.Request().Context(), c.Response())
}
