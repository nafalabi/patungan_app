...
func UserRow(user models.User) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/admin/user/pages/users_list.templ`, Line: 86, Col: 77}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/admin/user/pages/users_list.templ`, Line: 87, Col: 93}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/admin/user/pages/users_list.templ`, Line: 91, Col: 76}
		}
		...
		if user.Phone != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/admin/user/pages/users_list.templ`, Line: 94, Col: 22}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/admin/user/pages/users_list.templ`, Line: 109, Col: 71}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/admin/user/pages/users_list.templ`, Line: 116, Col: 64}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/admin/user/pages/users_list.templ`, Line: 124, Col: 94}
		}
