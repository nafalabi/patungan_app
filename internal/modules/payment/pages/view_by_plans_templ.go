			...
			if len(pwd.Periods) > 0 {
				for _, pwd_period := range pwd.Periods {
					...
					if pwd_period.Period.ID != 0 {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/payment/pages/view_by_plans.templ`, Line: 53, Col: 34}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/payment/pages/view_by_plans.templ`, Line: 55, Col: 61}
						}
...
func LoadMorePlansButton(nextOffset int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if nextOffset > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/payment/pages/view_by_plans.templ`, Line: 81, Col: 74}
			}
