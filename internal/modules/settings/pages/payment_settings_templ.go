...
func PaymentSettings(props PaymentSettingsProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"max-w-4xl mx-auto\"><div class=\"mb-6\"><h1 class=\"text-xl md:text-2xl font-bold text-text-primary tracking-tight\">Application Settings</h1><p class=\"text-xs md:text-sm text-text-secondary mt-0.5\">Manage payment gateways and global configurations</p></div><form action=\"/admin/settings\" method=\"POST\" class=\"space-y-6\"><!-- Active Gateway Selection --><div class=\"bg-bg-card rounded-xl border border-border overflow-hidden shadow-card\"><div class=\"p-4 border-b border-border bg-bg-subtle/50\"><h3 class=\"text-sm font-bold text-text-primary flex items-center gap-2\"><i data-lucide=\"sliders\" class=\"w-4 h-4 text-text-secondary\"></i> General Settings</h3></div><div class=\"p-5\"><label class=\"block text-xs font-semibold text-text-secondary uppercase tracking-wider mb-2\">Active Payment Gateway</label> <select name=\"active_payment_gateway\" class=\"w-full px-3.5 py-2 bg-bg-body border border-border rounded-lg text-text-primary text-xs focus:outline-none focus:ring-1 focus:ring-primary transition-colors\"><option value=\"midtrans\"")
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, ">Mayar.id</option></select><p class=\"mt-1.5 text-[11px] text-text-muted\">This gateway will be used for all new payment initiations by default.</p></div></div><div class=\"grid grid-cols-1 md:grid-cols-2 gap-5\"><!-- Midtrans Configuration --><div class=\"bg-bg-card rounded-xl border border-border overflow-hidden shadow-card\"><div class=\"p-4 border-b border-border bg-bg-subtle/50\"><h3 class=\"text-sm font-bold text-text-primary flex items-center gap-2\"><i data-lucide=\"credit-card\" class=\"w-4 h-4 text-text-secondary\"></i> Midtrans</h3></div><div class=\"p-5 space-y-3.5\"><div><label class=\"block text-xs font-semibold text-text-secondary uppercase tracking-wider mb-1\">Merchant ID</label> <input type=\"text\" name=\"midtrans_merchant_id\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/settings/pages/payment_settings.templ`, Line: 69, Col: 50}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/settings/pages/payment_settings.templ`, Line: 80, Col: 50}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/settings/pages/payment_settings.templ`, Line: 97, Col: 49}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/modules/settings/pages/payment_settings.templ`, Line: 130, Col: 44}
			}
